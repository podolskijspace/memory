# Memory
___
Приложение имитирующее игру, где надо найти одинаковые картинки. 
___
...
При запуске игры
запускается таймер и счетчик попыток. Если нажать сдаться, то ваш результат сохранится
с пометкой "проигравший". После выбора первой карты есть 5 секунд, чтобы выбрать вторую,
иначе она перевернется обратно. Если убрать все карты, то результат сохраняется. Результаты
хранятся на отдельной странице, можно перейти по кнопке.
</br></br>
